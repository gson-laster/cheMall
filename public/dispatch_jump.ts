...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script src="/thems/admin/static/js/jquery-1.7.2.min.js"></script>
        <style>
        *{margin:0;padding:0;list-style-type:none;}
        ...
        .tipInfo .in p span a{color:#e94c3c;margin: 0 5px}
            ...
            <div class="tipInfo">
                <div class="in">
                    <div class="textThis">
                        ...
                        <p><span>页面自动<a id="href" href="<?php echo($url);?>">立即跳转</a></span><span>等待<b id="wait"><?php echo($wait);?></b>秒</span></p>
