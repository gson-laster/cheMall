    ...
    MultiPicker.prototype = {
        ...
        generateArrData: function (targetArr) {
            ...
            loop(0, targetArr.length, function (i) {
                tempArr.push({
                    "id": targetArr[i].id,
                    "value": targetArr[i].name,
                    "level":targetArr[i].level,
                    "parent_id":targetArr[i]['parent_id']
                })
            });
            return tempArr;
        },
        ...
        initReady: function (idx, target) {
            ...
            loop(0, _this.idxArr.length, function (i) {
                ...
                _this.resultArr.push({
                    ...
                    "name": _this.jsonArr[i][_this.distance[i] / _this.liHeight + 2].value,
                    "level":_this.jsonArr[i][_this.distance[i] / _this.liHeight + 2].level,
                    "parent_id":_this.jsonArr[i][_this.distance[i] / _this.liHeight + 2]['parent_id'],
                });
            });
